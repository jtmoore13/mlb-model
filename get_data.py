...
def get_data(years):
    ...
    for year in years:
        ...
        data_utils.dump_data(year, 'team-bullpen-data.json', bullpen_data)
        data_utils.dump_data(year, 'pitcher-data.json', pitcher_data)
        data_utils.dump_data(year, 'game-data.json', season_games)
